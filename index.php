...
<html>
  ...
  <body>
    ...
    <div id="full-wrapper">
      <section id="services" class="bg-green white-text">
        <div class="container">
          <div class="title" data-wow-duration="1s">SERVICIOS</div>
      ...
      <section id="turns" class="bg-black-blue white-text">
        <div class="container">
      ...
      <section id="us" class="white">
        <div class="container">
          <div class="title" data-wow-duration="1s">NOSOTROS</div>
          ...
          <div class="row center"><b>INSTITUCIONES</b></div>
          <div class="row center">
    ...
    <footer id="contact" class="page-footer bg-black-blue white-text">
      <div class="container">
        <div class="row">
          <div class="title" data-wow-duration="1s">CONTACTO</div>
          ...
          <div class="col l6 m6 s12">
            <ul id="contact-list">
              <li><i class="small material-icons">phone</i> (297) 406-1411</li>
              <li><i class="small material-icons">phone</i> (297) 406-1412</li>
              <li><i class="small material-icons">email</i> unmail@mail.com</li>
              <li><i class="small material-icons">room</i> R. Sáenz Peña Y Democracia</li>
            </ul>
